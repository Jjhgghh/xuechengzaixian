...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto createOrder(String userId, AddOrderDto addOrderDto) {
        ...
        //todo adddto获取价格
        payRecordDto.setTotalPrice(new Float(10));
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        try {
           ...
           e.printStackTrace();
           XueChengPlusException.cast("查询交易失败");
        }
    ...
    public void notifyPayResult(MqMessage message) {
        ...
        Message message1 = MessageBuilder.withBody(jsonString.getBytes(StandardCharsets.UTF_8)).setDeliveryMode(MessageDeliveryMode.PERSISTENT)
                .build();
        ...
        correlationData.getFuture().addCallback(
                result -> {
                    ...
                    log.error("通知支付结果消息发送异常, ID:{}, 原因{}",ex.getMessage());
                }
        );
    ...
    public XcPayRecord createPayRecord(XcOrders orders){
        ...
        //todo adddto获取价格
        payRecord.setTotalPrice(new Float(10));
